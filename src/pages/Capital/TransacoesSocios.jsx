...
const TransacoesSocios = () => {
  ...
  const columns = [
    ...
    { header: 'Tipo', key: 'transaction_type', Cell: ({ row }) => (
        <span className={row.transaction_type === 'Aporte' ? styles.inflow : styles.outflow}>
  ...
  return (
    <div>
      ...
      <Card>
        {loading ? <p>A carregar...</p> : <Table columns={columns} data={transactions} />}
      </Card>
