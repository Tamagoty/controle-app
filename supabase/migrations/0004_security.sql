...
-- =================================================================
-- SCRIPT 4: POLÍTICAS DE SEGURANÇA (RLS) E STORAGE - VERSÃO CORRIGIDA
-- Ativa a segurança e define as regras de acesso para cada tabela
-- e para os buckets de armazenamento de forma idempotente.
-- =================================================================
...
DROP POLICY IF EXISTS "Allow individual user access to their own profile" ON public.user_profiles;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.entities;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.entity_roles;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.products;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.product_categories;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.product_stock;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.expense_categories;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.cost_centers;
...
DROP POLICY IF EXISTS "Allow access for managers and admins" ON public.partners;
...
DROP POLICY IF EXISTS "Allow manager and admin access to attachments" ON public.attachments;
...
DROP POLICY IF EXISTS "Allow modification for managers and admins" ON public.sales;
...
DROP POLICY IF EXISTS "Allow manager and admin to read attachments" ON storage.objects;
DROP POLICY IF EXISTS "Allow manager and admin to insert attachments" ON storage.objects;
DROP POLICY IF EXISTS "Allow manager and admin to delete attachments" ON storage.objects;
