...
const EntityForm = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { error } = await supabase.rpc('create_entity_with_roles', {
      ...
      notify.success('Entidade criada com sucesso!');
      if (onSuccess) onSuccess();
    } catch (error) {
      notify.error(error.message || 'Falha ao criar a entidade.');
    } finally {
      setLoading(false);
    }
  };
